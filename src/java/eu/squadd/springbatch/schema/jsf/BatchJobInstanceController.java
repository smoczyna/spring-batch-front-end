...
@SessionScoped
public class BatchJobInstanceController implements Serializable {

    @EJB
    private eu.squadd.springbatch.schema.ejb.BatchJobInstanceFacade ejbFacade;
    private List<BatchJobInstance> items = null;
    private BatchJobInstance selected;
    ...
    public void setSelected(BatchJobInstance selected) {
    ...
    private BatchJobInstanceFacade getFacade() {
        return ejbFacade;
    }

    public BatchJobInstance prepareCreate() {
        selected = new BatchJobInstance();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("BatchJobInstanceCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("BatchJobInstanceUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("BatchJobInstanceDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<BatchJobInstance> getItems() {
        if (items == null) {
    ...
    public BatchJobInstance getBatchJobInstance(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<BatchJobInstance> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<BatchJobInstance> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class BatchJobInstanceControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getBatchJobInstance(getKey(value));
        }
