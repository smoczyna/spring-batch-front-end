...
@SessionScoped
public class BatchStepExecutionController implements Serializable {

    @EJB
    private eu.squadd.springbatch.schema.ejb.BatchStepExecutionFacade ejbFacade;
    private List<BatchStepExecution> items = null;
    private BatchStepExecution selected;
    ...
    public void setSelected(BatchStepExecution selected) {
    ...
    private BatchStepExecutionFacade getFacade() {
        return ejbFacade;
    }

    public BatchStepExecution prepareCreate() {
        selected = new BatchStepExecution();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("BatchStepExecutionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("BatchStepExecutionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("BatchStepExecutionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<BatchStepExecution> getItems() {
        if (items == null) {
    ...
    public BatchStepExecution getBatchStepExecution(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<BatchStepExecution> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<BatchStepExecution> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class BatchStepExecutionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getBatchStepExecution(getKey(value));
        }
